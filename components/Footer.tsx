      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-10 md:flex-row md:items-start">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="mb-6 flex flex-col items-center gap-2 md:items-start">
            <a href="mailto:askpsychembassy@gmail.com" className="text-sm text-[#FBF8F2]/70 transition-colors hover:text-[#88B7B5]">
              askpsychembassy@gmail.com
            </a>
            <a 
              href="https://wa.me/916367456175" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center gap-2 text-sm text-[#FBF8F2]/70 transition-colors hover:text-[#88B7B5]"
            >
