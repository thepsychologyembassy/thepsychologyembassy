    ...
    <main className="relative isolate text-[#3A3A38]">
      ...
      <section ref={heroRef} className="relative h-[100vh] w-full overflow-hidden">
        ...
        <div className="hero-text relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          ...
          <div className="mt-6 max-w-2xl space-y-4 font-sans text-sm sm:text-base text-[#FBF8F2]/90 leading-relaxed drop-shadow-md">
            <p>
          ...
          <Link href="/book" className="mt-8 rounded-full bg-[#F6D86B] px-8 py-3.5 text-sm font-bold uppercase tracking-widest text-[#3A3A38] transition-transform hover:-translate-y-1 hover:shadow-[0_8px_20px_rgba(246,216,107,0.3)]">
            Book a Session
          </Link>
        </div>
      </section>
      ...
      {/* 3. SERVICES WE OFFER (Replaces Timeline) */}
      <section className="relative w-full bg-[#FBF8F2] px-6 py-24 sm:py-32">
        <div className="relative z-10 mx-auto mb-16 text-center">
          <p className="mb-2 text-sm font-semibold uppercase tracking-[0.35em] text-[#88B7B5]">What We Do</p>
          <h2 className="font-serif text-4xl font-medium tracking-wide text-[#2C4C5B] sm:text-5xl">
            Services We Offer
          </h2>
        </div>
        <div className="relative z-10 mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-8">
          
          <div className="service-card flex flex-col rounded-3xl border border-[#3A3A38]/10 bg-white p-10 shadow-[0_8px_30px_rgba(0,0,0,0.03)] transition-all hover:-translate-y-2 hover:shadow-xl">
            ...
            <ul className="flex flex-col gap-3 text-sm leading-relaxed text-[#3A3A38]/70 list-disc pl-5 marker:text-[#A65D47]">
          ...
          <div className="service-card flex flex-col rounded-3xl border border-[#3A3A38]/10 bg-white p-10 shadow-[0_8px_30px_rgba(0,0,0,0.03)] transition-all hover:-translate-y-2 hover:shadow-xl">
            ...
            <ul className="flex flex-col gap-3 text-sm leading-relaxed text-[#3A3A38]/70 list-disc pl-5 marker:text-[#4F6F52]">
              <li>Courses</li>
              <li>Internships</li>
          ...
          <div className="service-card flex flex-col rounded-3xl border border-[#3A3A38]/10 bg-white p-10 shadow-[0_8px_30px_rgba(0,0,0,0.03)] transition-all hover:-translate-y-2 hover:shadow-xl">
            ...
            <ul className="flex flex-col gap-3 text-sm leading-relaxed text-[#3A3A38]/70 list-disc pl-5 marker:text-[#2C4C5B]">
